##simulation for irregular window
...
W_new$yrange <- range(W_new$ vvbdry[[1]]$y)
...
#df <- data.frame(data)
#ggplot(df, aes(x = x, y = y, color = factor(marks))) + 
 # geom_point() + 
 # theme_minimal() + 
  #labs(color = "Cell Type") + 
 # ggtitle("Simulated Clustered Point Pattern with Marks")
#pval.assoc(data, base.taxa = base.taxa, shift.taxa = shift.taxa,r = r, n.perm = 199)
...
saveRDS(list(K1M1 = K1M1, K1M2 = K1M2, K1M3 = K1M3, K2M1 = K2M1, K2M2 = K2M2, K2M3 = K2M3, K3M1 = K3M1, K3M2 = K3M2, K3M3 = K3M3,
        ...
        file = "size3_Wnew.rds") #file = "size5_Wnew.rds"
beepr::beep(4)
